...
pub fn build(ui: &mut Ui, charts: &Rc<RefCell<Vec<ObjRef>>>) {
    ...
    let led = LedCfg::new(Rgb888::new(60, 180, 90)).build(ui, led_row);
    ...
    let chart1 = ChartCfg::new()
        .range(0, 100)
        .series(Rgb888::new(80, 140, 255), 48)
		.line_width(1)
    ...
    let chart2 = ChartCfg::new()
        .range(0, 100)
        .series(Rgb888::new(255, 160, 60), 48)
        .build(ui, page_itemlist);
    ...
    for i in 0..8 {
        ...
        let led = LedCfg::new(Rgb888::new(60, 180, 90)).size(10, 10).build(ui, item);
