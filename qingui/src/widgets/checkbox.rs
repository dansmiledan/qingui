...
impl CheckboxState {
    fn draw_box<C: PixelFormat>(&self, ctx: &WidgetCtx, d: &mut Canvas<'_, C>, clip: Rect) {
        ...
        // Box
        d.draw_border(brect, 1, 2, Color::rgb(150, 150, 160), 255, clip);
        if self.checked {
            ...
            d.draw_line(p1, p2, 2, Color::rgb(80, 140, 255), 255, clip);
            d.draw_line(p2, p3, 2, Color::rgb(80, 140, 255), 255, clip);
        }
        d.draw_text_opa(
